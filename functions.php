...
function hoogah_rewrite_rules() {
    ...
    add_rewrite_rule( '^for-event-organizers/?$', 'index.php?hoogah_page=for-event-organizers', 'top' );
    add_rewrite_rule( '^event-organizers/?$',     'index.php?hoogah_page=redirect-for-event-organizers', 'top' );
    add_rewrite_rule( '^lp-event-organizers/?$',  'index.php?hoogah_page=redirect-for-event-organizers', 'top' );
    add_rewrite_rule( '^homepage-v3/?$',  'index.php?hoogah_page=homepage-v3',  'top' );
    add_rewrite_rule( '^homepage-v1/?$',  'index.php?hoogah_page=homepage-v1',  'top' );
